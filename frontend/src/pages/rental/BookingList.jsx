...
const BookingList = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-32 font-['Outfit']">
      ...
      <div className="px-6 pt-10 pb-5 bg-[var(--header-color)] flex items-center justify-between sticky top-0 z-40 border-b border-white/5 shadow-2xl">
          <button 
             onClick={() => navigate(-1)}
          ...
          <div className="text-center">
             <span className="text-[7px] font-bold tracking-[0.3em] text-[var(--primary-color)] uppercase block mb-0.5">Fleet Terminal</span>
          ...
          >
            <div className="flex items-start justify-between mb-4">
               <div className="flex flex-col">
                  <span className="text-[7px] font-bold text-[var(--primary-color)] uppercase tracking-widest leading-none mb-1.5">{item.id}</span>
               ...
               <div className={twMerge(
                 ...
                 item.active ? "bg-[var(--primary-color)] border-[var(--primary-color)] text-white" : "bg-emerald-50 border-emerald-100 text-emerald-600"
               )}>
                  {item.status}
               </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 py-4 border-y border-slate-50 border-dashed mb-4">
               <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold text-[var(--secondary-color)] underline decoration-4 underline-offset-4">{item.date}</span>
               </div>
               <div className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between">
               ...
               <button 
                  className="h-9 px-6 bg-[text-[var(--primary-color)]] text-white rounded-xl text-[8.5px] font-bold uppercase tracking-widest transition-all active:scale-95 shadow-lg border border-white/10"
                >
                  Unit Details
               </button>
            </div>
